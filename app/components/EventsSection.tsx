...
export default function EventsSection({
  ...
  return (
    <section className="section flex flex-col md:flex-row items-center relative bg-beige w-full md:w-[120vw] h-auto md:h-screen !pt-[60px] !pb-[60px] !px-6 md:my-0 md:!pt-16 md:!pb-16 md:!px-20 lg:!pt-20 lg:!pb-20 lg:!px-16">
      ...
      >
        {/* Two Landscape Images - Stacked Vertically, Staggered Horizontally */}
        <div className="flex flex-col gap-5 md:gap-6 lg:gap-8 w-full h-auto relative items-center justify-center">
          {/* First Image - Landscape, offset left */}
          <motion.div
            className="w-full lg:w-[85%] h-auto overflow-hidden aspect-[21/9] lg:self-start"
          ...
          {/* Second Image - Landscape, offset right */}
          <motion.div
            className="w-full lg:w-[85%] h-auto overflow-hidden aspect-[21/9] lg:self-end"
            variants={imageVariants}
          >
            <img
